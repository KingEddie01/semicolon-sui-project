            ...
            <section className="mx-auto my-16 max-w-6xl px-4 py-8">
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p className="mb-4">
                            <span className="font-semibold text-blue-600">SUI Lagos Hacker House</span> is a 6-day event
                            designed to bring together developers, engineers, builders, innovators, and blockchain
                            enthusiasts interested in building on the Sui blockchain.
                        </p>
                        <p className="mb-4">
                            The event will feature workshops, mentorship, and coaching sessions, along with hacking and networking
                            ...
                            <a href="#" className="font-semibold text-blue-600 underline cursor-pointer" target="_blank" rel="noopener noreferrer">
                        ...
                        <p className="mb-4">
                            ...
                            <a href="#" className="font-semibold text-blue-600 underline" target="_blank" rel="noopener noreferrer">
                                &nbsp;Semicolon
                            </a>
                            &nbsp;and sponsored by
                            <a href="#" className="font-semibold text-blue-600 underline cursor-pointer" target="_blank" rel="noopener noreferrer">
